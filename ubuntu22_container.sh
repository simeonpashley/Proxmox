...
wget -qL https://raw.githubusercontent.com/simeonpashley/Proxmox/main/ubuntu22_setup.sh
...
pct start $CTID
pct push $CTID ubuntu22_setup.sh /ubuntu22_setup.sh -perms 755
pct exec $CTID /ubuntu22_setup.sh
